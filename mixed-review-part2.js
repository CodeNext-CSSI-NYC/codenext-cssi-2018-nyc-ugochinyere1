...
//     var index = cafes.indexOf();
//     var randCafe = randomInt(index, cafes.length);
//
//   }
//
//   return randCafe;
...
/*
  ...
  var userDecision = readline.question("touchdown(td) or field goal(fg)?: ");
  var score = {
    scoreTd: 0,
    scoreFg: 0,
  };
  for (var i = 0; i < array.length; i++) {
    ...
    if (userDecision == "touchdown" || userDecision == "td") {
      scoreTd += 7;

    } else if (userDecision == "field goal" || userDecision == "fd") {
      scoreFg += 3;
    }
